...
export default function Page() {
  return (
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
      <div>
        <h1 className="font-serif text-[28px] font-medium tracking-tight mb-1 text-[#111111]">Location</h1>
      ...
      <div className="bg-white rounded-[16px] border border-black/5 p-12 text-center shadow-[0_2px_8px_rgba(0,0,0,0.02)]">
        <h2 className="text-[16px] font-semibold text-[#111111] mb-2">Location Prototype</h2>
